...
router.get('/dashboard', async (req, res) => {
    try {
        ...
        // Return JSON for React frontend instead of rendering EJS
        res.json({
            success: true,
            user: {
            ...
            upcomingEventsCount,
            registrationCount: registeredTeamsCount,
            cancelledEventsCount,
            completedEventsCount,
            totalEventsCount,
            recentActivities,
            upcomingEvents,
            recentEvents: upcomingEvents, // For backwards compatibility
            nextEvent,
            sportsDistribution,
            monthlyEventCounts,
            isNewOrganizer
...
// GET /api/organizer/events - Get all events for React frontend
